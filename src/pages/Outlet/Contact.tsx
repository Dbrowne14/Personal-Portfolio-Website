...
<section className="rounded-2xl">
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-3xl">
      ...
      <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">For any inquiries and reach-outs please get in touch through the following.</p>
      <form action="#" className="space-y-8">
          ...
          <div className="sm:col-span-2">
              ...
              <textarea id="message" rows={6} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Hey David love the website would like to chat about some opportunities you might like!"></textarea>
          </div>
